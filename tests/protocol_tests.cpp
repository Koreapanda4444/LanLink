...
void test_constants() {
    ...
    expect(protocol_version == 5, "protocol version");
    expect(protocol_alpn == "lanlink/5", "protocol alpn");
...
void test_message_round_trips() {
    ...
    constexpr std::array types{
        ...
        MessageType::network_key_publish_request,
        ...
        MessageType::network_key_envelope,
        MessageType::error,
    };
...
void test_malformed_frames() {
    ...
    unsupported_version[5] = std::byte{4};
